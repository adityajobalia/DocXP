...
import com.project.healingtouch.services.DoctorListofAppointmentServices;

public class DoctorListofAppointmnetController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("====doc list of apointment====");
		...
		DoctorListofAppointmentServices services =  new DoctorListofAppointmentServices();
		ArrayList<DoctorListofAppointmenBean> lst=services.verifyDoctorListofAppointmentData(bean);
