...
public class DoctorListofAppointmentDB {
	...
	public ArrayList<DoctorListofAppointmenBean> getDocListofAppointmentData(DoctorListofAppointmenBean bean) {
		...
		try {
			...
			PreparedStatement getData_stmt= con.prepareStatement(QueryCollection.DOC_LIST_OF_APPOINTMENT_DATA);
			getData_stmt.setString(1, doc_name);
			getData_stmt.setString(2, doc_hospitalname);
			getData_stmt.setString(3, "pending");
